...
void topic_callback(const sensor_msgs::JointState::ConstPtr & ros1_msg)
{
...
int main(int argc, char * argv[])
{
  ...
  auto node = rclcpp::Node::make_shared("bridge_joint_state");
  ...
  pub = node->create_publisher<sensor_msgs::msg::JointState>(topic_name, qos);
